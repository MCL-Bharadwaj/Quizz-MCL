...
public class StudentEndpoints
{
    ...
    public StudentEndpoints(ILogger<StudentEndpoints> logger, IDbService dbService, TokenService tokenService)
    {
        _logger = logger;
    ...
    [OpenApiOperation(operationId: "GetStudentLevels", tags: new[] { "Student" }, Summary = "Get student's enrolled levels", Description = "Get all levels the student is enrolled in with progress")]
    [OpenApiSecurity("bearer_auth", SecuritySchemeType.Http, Scheme = OpenApiSecuritySchemeType.Bearer, BearerFormat = "JWT")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(List<object>), Description = "List of enrolled levels with progress")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.Unauthorized, contentType: "application/json", bodyType: typeof(object), Description = "Authentication required or not a student")]
    ...
    [OpenApiOperation(operationId: "GetStudentQuizzes", tags: new[] { "Student" }, Summary = "Get student's quizzes", Description = "Get all quizzes for a specific level or all enrolled levels")]
    [OpenApiSecurity("bearer_auth", SecuritySchemeType.Http, Scheme = OpenApiSecuritySchemeType.Bearer, BearerFormat = "JWT")]
