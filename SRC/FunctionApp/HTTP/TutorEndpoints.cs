...
public class TutorEndpoints
{
    ...
    public TutorEndpoints(ILogger<TutorEndpoints> logger, IDbService dbService, TokenService tokenService)
    {
        _logger = logger;
    ...
    [OpenApiOperation(operationId: "GetTutorLevels", tags: new[] { "Tutor" }, Summary = "Get tutor's assigned levels", Description = "Get all levels assigned to the tutor with statistics")]
    [OpenApiSecurity("bearer_auth", SecuritySchemeType.Http, Scheme = OpenApiSecuritySchemeType.Bearer, BearerFormat = "JWT")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(List<object>), Description = "List of assigned levels with statistics")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.Unauthorized, contentType: "application/json", bodyType: typeof(object), Description = "Authentication required or not a tutor/admin")]
    ...
    [OpenApiOperation(operationId: "GetStudentResponses", tags: new[] { "Tutor" }, Summary = "Get student responses", Description = "Get student responses for quizzes in assigned levels")]
    [OpenApiSecurity("bearer_auth", SecuritySchemeType.Http, Scheme = OpenApiSecuritySchemeType.Bearer, BearerFormat = "JWT")]
    [OpenApiParameter(name: "levelId", In = ParameterLocation.Query, Required = false, Type = typeof(Guid), Description = "Filter by specific level (optional)")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(List<object>), Description = "List of student responses")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.Unauthorized, contentType: "application/json", bodyType: typeof(object), Description = "Authentication required or not a tutor/admin")]
    ...
    [OpenApiOperation(operationId: "GetLevelStudents", tags: new[] { "Tutor" }, Summary = "Get students in levels", Description = "Get all students in tutor's assigned levels")]
    [OpenApiSecurity("bearer_auth", SecuritySchemeType.Http, Scheme = OpenApiSecuritySchemeType.Bearer, BearerFormat = "JWT")]
    [OpenApiParameter(name: "levelId", In = ParameterLocation.Query, Required = false, Type = typeof(Guid), Description = "Filter by specific level (optional)")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(List<object>), Description = "List of students")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.Unauthorized, contentType: "application/json", bodyType: typeof(object), Description = "Authentication required or not a tutor/admin")]
